...
/// 2-min window: active when time_elapsed in [120s, THREE_MIN_AFTER_SECONDS) i.e. 2 min to 3 min.
...
async fn main() -> Result<()> {
    ...
    monitor_arc.start_monitoring(move |snapshot| {
        ...
        let _two_min_trailing_reset_at_3min = two_min_trailing_reset_at_3min.clone();
